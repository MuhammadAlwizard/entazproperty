...
export const en: Dict = {
  ...
  services: { title: 'Choose a service', note: 'Open a service to see every listing, its location, and its price.', soon: 'Coming soon', from: 'from', other: 'See other services' },
  categories: {
    villa: {
      ...
      empty: 'We are preparing this service. Please check back soon.',
    },
    mobil: {
