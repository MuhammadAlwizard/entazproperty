...
export const ar: Dict = {
  ...
  services: { title: 'اختر الخدمة', note: 'افتح أي خدمة لتشاهد جميع العروض ومواقعها وأسعارها.', soon: 'قريبًا', from: 'ابتداءً من' },
  categories: {
    villa: {
      ...
      empty: 'لا توجد عروض في هذه الفئة حاليًا. يرجى المراجعة لاحقًا.',
    },
    mobil: {
