...
export const id: Dict = {
  ...
  services: { title: 'Pilih layanan', note: 'Buka satu layanan untuk melihat semua listing, lokasi, dan harganya.', soon: 'Segera hadir', from: 'mulai' },
  categories: {
    villa: {
      ...
      empty: 'Belum ada listing di kategori ini. Silakan cek lagi nanti.',
    },
    mobil: {
